...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_03ef949a272279f3ca7d9e06c3407b7f4fed5a2d": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). putImageData (new ImageData (Uint8ClampedArray.from (($2)), 64 , 48 ,), 0 , 0);})());
            },
            ...
            "__extjs_e001f6c302ae4d42c370695f0aca6513a1ae20e4": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return Math.floor (Math.random ()* 0xFFFFFFFF);})());
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'web'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'web':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" ) {
        ...
        const wasm_path = path.join( __dirname, "web.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "web.wasm" )
